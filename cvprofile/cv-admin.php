...
text-decoration:none;
	...
	outline: none;
	cursor:pointer;
    font-size:20px" href="/Booking Coffee System/management-web/adminpage.php">BACK</a></div>
<div class="resume">

   <div class="resume_left">
     <div class="resume_profile">
       <img src="adminc.jpg" alt="profile_pic">
     </div>
     <div class="resume_content">
       <div class="resume_item resume_info">
         <div class="title">
           <p class="bold">Saleem Ali</p>
    ...
    <div class="resume_item resume_education">
      ...
      <ul>
            <li>
                ...
                <div class="info">
                     <p class="semi-bold">Web Designing (Baghdad University)</p> 
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, voluptatibus!</p>
                </div>
            </li>
            <li>
              ...
              <div class="info">
                     <p class="semi-bold">Baghdad International School</p> 
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, voluptatibus!</p>
                </div>
            </li>
        </ul>
